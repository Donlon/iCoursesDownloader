...
MainWnd::MainWnd(QWidget *parent) : QMainWindow(parent){
    ...
    connect(coursesWnd,    &QDialog::finished, this, &MainWnd::onSubWndClose);
    connect(settingsWnd,   &QDialog::finished, this, &MainWnd::onSubWndClose);
    connect(downloaderWnd, &QDialog::finished, this, &MainWnd::onSubWndClose);
